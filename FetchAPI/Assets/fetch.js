...
logalStorage.nombre = document.getElementById("nombre").value; //guardar el valor de nombre en localStorage

logalStorage.password = document.getElementById("password").value; //guardar el valor de password en localStorage

/*
Cuando hablamos del DOM, estamos hablando de dos representaciones de nuestra pagina: una de ellas en la representción del codigo fuerte (la estructura del HTML) y la otra es la represnetación visual (la estructura del DOM)

Nodos
Es la unidad mas basica que puede ser modificado, que puede ser uuna etiqueta o element o un modo de texto.
...
<h1> {Papá
    Hola Generation { hijito o nodo de texto
        ...
        Docuemnt: El nodo raiz a partir del cual se derivan los demans nodos. Este objeto es el que nos permite acceder a todos los elementos del DOM. Todos los nodos derivan del document.
...
Seleccionar elementos
        Siven para realizar busquedas de elementos dentro del documento
        - getElementById("IDElement"): Buscar elementos por ID
        - getElementByClassName("nombreClase") : Buscar elementos por el nombre de clase
        - getElementsByTagName(): Buscar un elemento por su etiqueta
        --getElementsByTagName(): Busca un elemento por su nombre
...
const elementClass = document.getElementByClassName("parrafitos");

//getElementByTagName y ByName
const elementTag = document.getElementsByTagName("p");
const elementName = docuemnt.getElementsByName("primerparrafo");
...
const crearImage = document.createElement("img");
...
Son metodos que nos van a permitir hacer modificaciones a nuestros elementos dentro del documento HTML
        ...
        -textConten: Mostrar el contenido en texto de un element
...
//innerHTML
parrafo1.innerHTML = ("Lo siento, ahora yo soy el texto del parrado 1");

//Ejemplo del PlayStation
// nombreDelProducto.innerHTML
// precioProducto.innerHTML
// imagenProducto.innerHTML =(imagen.png)
...
//Explicación: primero creamos un elemento (etiqueta) llamada img (existente de forma virtual), le agregamos atributos como src y alt, y por ultimo conectamos al DOM usando el appendChild sobre nuestro documento.body
...
const button = document.querySelectorAll(".botonSaludo");
button.addEventListener("clik", function(){
    alert("Hola, saludos con Event Lister");
});
